...
#pragma once
#ifndef AsymWaveshaper_Faust_pp_Gen_HPP_
#define AsymWaveshaper_Faust_pp_Gen_HPP_
...
public:
    ...
    float get_amount() const noexcept;
    
    
    void set_amount(float value) noexcept;
...
#endif // AsymWaveshaper_Faust_pp_Gen_HPP_
