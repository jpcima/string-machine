...
namespace MainLayout {
    ...
    DECL_IGNORABLE static Rect knob_OscDetune = {40, 145, 30, 30};
    DECL_IGNORABLE static Rect val_OscDetune = {35, 178, 40, 12};
    ...
    DECL_IGNORABLE static Rect btn_ChoEnabled = {485, 45, 35, 15};
    DECL_IGNORABLE static Rect btn_ChoModel = {565, 45, 35, 15};
    ...
    DECL_IGNORABLE static Rect plot_Env = {860, 155, 105, 50};
    ...
    DECL_IGNORABLE static Label knob_OscDetune_label = {"Detune", 1, {40, 145, 30, 30}};
    ...
    DECL_IGNORABLE static Label knob_OscHpCutoffUpper_label = {"4' HP", 1, {130, 80, 30, 30}};
    DECL_IGNORABLE static Label knob_OscHpCutoffLower_label = {"8' HP", 1, {130, 145, 30, 30}};
    ...
    DECL_IGNORABLE static Label btn_ChoEnabled_label = {"On/Off", 1, {485, 45, 35, 15}};
    DECL_IGNORABLE static Label btn_ChoModel_label = {"Analog mode", 1, {565, 45, 35, 15}};
